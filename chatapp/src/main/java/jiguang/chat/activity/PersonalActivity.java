...
public class PersonalActivity extends BaseActivity implements SelectAddressInterface, View.OnClickListener {
    ...
    public static final int FLAGS_SIGN = FLAG_GRANT_WRITE_URI_PERMISSION;
    public static final String SIGN_KEY = "sign_key";

    public static final int NICK_NAME = 4;
    public static final int FLAGS_NICK = FLAG_FROM_BACKGROUND;
        ...
        switch (v.getId()) {
            case R.id.iv_photo:
                ...
                if ((ContextCompat.checkSelfPermission(PersonalActivity.this, Manifest.permission.CAMERA) != PackageManager
                        .PERMISSION_GRANTED) ||
                        (ContextCompat.checkSelfPermission(PersonalActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) !=
